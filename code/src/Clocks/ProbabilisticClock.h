...
/** Probabilistic clocks. Clocks with M<N entries, where N corresponds to the number of nodes of the
 * system. Probabilistic clocks are used as causal information appended to messages. */
