...
vector<idMsg> ErrorDetectorInterval::determineAndGetAppendedDependencies(const vector<messageInfo>& delivered,
...
bool ErrorDetectorInterval::isConsideredAsPossibleDependency(const messageInfo& message,
 ...
 * */
vector<idMsg> ErrorDetectorInterval::sortPossibleDependenciesSet(const messageInfo& message,
 ...
 * */
PartialDependencies ErrorDetectorInterval::getPartialDependencies(const vector<messageInfo>& delivered,
                                                                  const ProbabilisticClock& clock) {
    messageInfo message;
    message.clock = clock;
