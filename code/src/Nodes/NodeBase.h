...
class NodeBase : public cSimpleModule {
   protected:
    ...
    /** Used to have a random variation in the broadcast time of application messages. Each node broadcast a message at
     * baseTimeBroadcast + sendDelay + variableDelay, with variableDelay generated with that random engine.*/
