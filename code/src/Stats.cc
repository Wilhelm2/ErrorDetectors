 ...
 * The only message Stats receives is the timeout it schedules to write
 * statistics into files. The function writes the statistics down into files
 * depending on the type of simulation, determined by the Delivery parameter of
 * SimulationParameters
 * @param msg Received message. Stats only receives the timeout it scheduled
 * itself to take statistics.
 */
...
/**@brief Writes into a file as well as on the error console the number of
 * messages nodes have delivered.
 */
...
/** @brief Writes into a file as well as on the error console the number of
 * messages nodes have delivered out of causal order.
 */
...
/** @brief Writes into a file as well as on the error console the number of
 * dependencies processes appended on messages.
 */
...
/** @brief Writes into a file the size of control information appended on
 * messages.
 */
...
/** @brief Prints on the error console for each node the number of pending
 * messages.
 */
...
/** @brief Writes into a file the number of true and false positives of the
 * error detectors.
 */
...
/** @brief Writes into a file for each node the number of computed hashes, as
 * well as in total the average of computed hashes per message delivery.
 */
...
/** @brief Writes into a file the number of messages to combine by hash error
 * detectors when computing the hash of messages.
 */
...
/** @brief Writes into a file the number of messages wrongly considered as
 * causal dependencies by hash error detectors.
 */
...
/** @brief Writes into a file the number of message combinations done by hash
 * error detectors when finding the hash of messages.
 */
...
/** @brief Writes into a file the number of operations done by hash error
 * detectors to find the hash of messages.
 */
...
/** @brief Writes into a file the number of message recoveries done by each
 * node, as well as total number of recoveries and the recovery rate compared to
...
/** @brief Writes into a file the number of avoided recoveries as well as its
 * rate compared to the total number of message deliveries.
 */
...
/** @brief Prints on the error console the number of messages to recover by each
 * node.
 */
...
/** @brief Prints on the error console the number of message broadcasts jumped
 * by each node.
 */
