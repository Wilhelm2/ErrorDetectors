...
class Stats : public cSimpleModule {
   private:
    ...
    /** Stream to write into a file the statistics about the number of messages wrongly considered as message
     * dependencies in the hash computation*/
    std::ofstream nbMsgWronglyConsideredCausalDepFile;
    /** Stream to write into a file the statistics about the number of computed hashes by the hash error detector to
     * find the hash appended to messages*/
    ...
    /** Stream to write into a file the statistics about the number of operations done by hash error detectors to find
