...
\begin{DoxyCompactList}\small\item\em Each message has an unique identifier composed of the id of the node \$p\+\_\+i\$ that sent it and the sequence number \$p\+\_\+i\$ associated to the message. \end{DoxyCompactList}\item 
