...
class NodeWithRecovery : public NodeDetector
{
    ...
    protected:
        ...
        /** Set to true if the node tries to broadcast a message during recovery. Is set to false at the end of the recovery*/
        ...
        /** List containing the messages to recover when a recovery is already in progress. The messages are pushed back to the pending message list at the end of the recovery.*/
