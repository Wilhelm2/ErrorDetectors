...
bool NodeWithRecoveryTest::testDeliverMessage(dep m)
{
...
bool NodeWithRecoveryTest::recoveryTest(dep message, vector<dep>& delivered, vector<unsigned int> incrementedClockEntries)
{
    ...
    {
        detector.stats.doneCombinationsToFindHash[nbHashs]++;
...
bool NodeWithRecoveryTest::TryCombinationsRecoveringMessages(dep message, unsigned int& nbHashs, TotalDependencies baseDependencies, vector<idMsg> messagesToCombine)
{
...
vector<idMsg> NodeWithRecoveryTest::createRecoveredMessagesToCombine(dep message, vector<unsigned int> incrementedClockEntries)
{
    vector<dep> recoveredTmp;
